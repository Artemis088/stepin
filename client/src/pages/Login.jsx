...
import { useToast, Icon, PasswordInput, Lockup } from '../components/ui.jsx';
...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, background: '#eaece7' }}>
      ...
      <form onSubmit={submit} style={{ background: '#fdfdfd', border: '0.5px solid var(--border)', borderRadius: 16, padding: 30, width: '100%', maxWidth: 380 }}>
