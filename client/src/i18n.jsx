...
const dict = {
  en: {
    ...
    // task detail
    'td.backToTasks': 'Back to tasks',
    'td.internshipLead': 'This is an internship.',
    'td.internshipBannerBody': 'You enter through the trial task below. The finalist who does best is hired into the internship — a guaranteed outcome for the winner.',
    'td.standaloneLead': 'One-off task.',
    'td.standaloneBannerBody': 'It builds your verified profile — no internship is guaranteed, but a company that likes your work may reach out later.',
    'td.theTask': 'The task',
    'td.doneLooks': 'What "done" looks like',
    'td.skillsWanted': 'Skills wanted',
    'td.youHaveThis': 'you have this',
    'td.reward': 'Reward',
    'td.rewardBase': 'Reputation, a badge, a portfolio piece',
    'td.rewardStipendBold': 'and ${amount} in pay',
    'td.noStipendNote': '(no pay on this task)',
    'td.whatApplying': 'What applying involves',
    'td.involve1': 'Do a ~30 min screening step (not the full task yet)',
    'td.involve2': 'If shortlisted (best 3–5), you do the real task',
    'td.involve3': 'Finalists give a short walkthrough of their work',
    'td.involveHired': 'The best finalist is hired into the internship',
    'td.involveProfile': 'Your score builds your verified profile — no task is wasted',
    'td.appliedLabel': 'Applied',
    'td.screeningSlots': 'Screening slots',
    'td.fillsNote': 'fills by who completes first · {n} held for newcomers',
    'td.screeningDue': 'Screening due',
    'td.taskDueFinalists': 'Task due (finalists)',
    'td.companyDecides': 'Company decides',
    'td.continueScreening': 'Continue to screening',
    'td.viewApplication': 'View my application',
    'td.youreIn': "You're in — stage:",
    'td.signUpToApply': 'Sign up to apply',
    'td.expressInterest': 'Express interest',
    'td.guestApplyNote': 'Create a free account to apply and start the trial task',
    'td.grabsSlot': 'grabs 1 of the {n} applied slots',
    'td.grabbedSlot': 'You grabbed a slot — now do the screening step',

    // application funnel stages
    'stage.interested': 'interested',
    'stage.screening_submitted': 'screening submitted',
    'stage.shortlisted': 'shortlisted',
    'stage.not_selected': 'not selected',
    'stage.doing_task': 'doing task',
    'stage.live_defense': 'live defense',
    'stage.awaiting_decision': 'awaiting decision',
    'stage.won': 'won',
    'stage.lost': 'lost',
    'stage.no_show': 'no show',
  },
  ...
  ka: {
    ...
    // task detail
    'td.backToTasks': 'დავალებებზე დაბრუნება',
    'td.internshipLead': 'ეს არის სტაჟირება.',
    'td.internshipBannerBody': 'შენ ხვდები ქვემოთ მოცემული საცდელი დავალებით. საუკეთესო ფინალისტი ინიშნება სტაჟირებაზე — გარანტირებული შედეგი გამარჯვებულისთვის.',
    'td.standaloneLead': 'ერთჯერადი დავალება.',
    'td.standaloneBannerBody': 'ის ქმნის შენს დადასტურებულ პროფილს — სტაჟირება გარანტირებული არ არის, მაგრამ კომპანია, რომელსაც მოეწონება შენი ნამუშევარი, შესაძლოა მოგვიანებით დაგიკავშირდეს.',
    'td.theTask': 'დავალება',
    'td.doneLooks': 'როგორ გამოიყურება „დასრულებული"',
    'td.skillsWanted': 'საჭირო უნარები',
    'td.youHaveThis': 'ეს გაქვს',
    'td.reward': 'ჯილდო',
    'td.rewardBase': 'რეპუტაცია, ბეიჯი და პორტფოლიოს ნამუშევარი',
    'td.rewardStipendBold': 'და ${amount} ანაზღაურება',
    'td.noStipendNote': '(ამ დავალებაზე ანაზღაურება არ არის)',
    'td.whatApplying': 'რას მოიცავს განაცხადი',
    'td.involve1': 'გაიარე ~30 წუთიანი სკრინინგი (ჯერ არა სრული დავალება)',
    'td.involve2': 'თუ მოხვდი შერჩეულებში (საუკეთესო 3–5), შეასრულებ რეალურ დავალებას',
    'td.involve3': 'ფინალისტები მოკლედ წარადგენენ თავიანთ ნამუშევარს',
    'td.involveHired': 'საუკეთესო ფინალისტი ინიშნება სტაჟირებაზე',
    'td.involveProfile': 'შენი ქულა ქმნის დადასტურებულ პროფილს — არცერთი დავალება არ იკარგება',
    'td.appliedLabel': 'განაცხადები',
    'td.screeningSlots': 'სკრინინგის ადგილები',
    'td.fillsNote': 'ივსება დასრულების მიხედვით · {n} დაცულია ახალბედებისთვის',
    'td.screeningDue': 'სკრინინგის ვადა',
    'td.taskDueFinalists': 'დავალების ვადა (ფინალისტები)',
    'td.companyDecides': 'კომპანია წყვეტს',
    'td.continueScreening': 'სკრინინგზე გადასვლა',
    'td.viewApplication': 'ჩემი განაცხადის ნახვა',
    'td.youreIn': 'შენ ჩართული ხარ — ეტაპი:',
    'td.signUpToApply': 'დარეგისტრირდი განაცხადისთვის',
    'td.expressInterest': 'ინტერესის გამოხატვა',
    'td.guestApplyNote': 'შექმენი უფასო ანგარიში, რომ განაცხადო და დაიწყო საცდელი დავალება',
    'td.grabsSlot': 'იკავებს {n} ადგილიდან ერთს',
    'td.grabbedSlot': 'ადგილი დაიკავე — ახლა გაიარე სკრინინგი',

    // application funnel stages
    'stage.interested': 'დაინტერესებული',
    'stage.screening_submitted': 'სკრინინგი გაგზავნილია',
    'stage.shortlisted': 'შერჩეული',
    'stage.not_selected': 'არ შეირჩა',
    'stage.doing_task': 'ასრულებს დავალებას',
    'stage.live_defense': 'ცოცხალი დაცვა',
    'stage.awaiting_decision': 'გადაწყვეტილების მოლოდინში',
    'stage.won': 'გაიმარჯვა',
    'stage.lost': 'ვერ შეირჩა',
    'stage.no_show': 'არ გამოცხადდა',
  },
};
